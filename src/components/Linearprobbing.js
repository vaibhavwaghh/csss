    ...
    <React.Fragment>
      <div className="lp1">
        <h>
          ...
          at the hash's initial point. If the site we receive is already
          occupied, we look for a different one.
          <br />
          <br />
          The rehashing function is as follows: table-size = (n+1)% rehash(key).
          As may be seen in the sample below, the usual space between two probes
          is 1.
          <br />
          <br />
      ...
      <div class="slider">
        <div class="slide">
          <img src="https://i.ibb.co/Wkb2428/1.jpg" alt="Photo 1" />
        </div>
        <div class="slide">
          <img src="https://i.ibb.co/m0YZv6X/2.jpg" alt="Photo 2" />
        </div>
        <div class="slide">
          <img src="https://i.ibb.co/LQ1BpcH/3.jpg" alt="Photo 3" />
        </div>
        <div class="slide">
          <img src="https://i.ibb.co/Jvg9c1r/4.jpg" alt="Photo 4" />
        </div>
        <div class="slide">
          <img src="https://i.ibb.co/YkjHqft/5.jpg" alt="Photo 4" />
        </div>
        <div class="slide">
          <img src="https://i.ibb.co/982f2DT/6.jpg" alt="Photo 4" />
        </div>
        <div class="slide">
          <img src="https://i.ibb.co/GJ8HzHY/7.jpg" alt="Photo 4" />
        </div>
      ...
      <div className="lp2">
        <strong>Primary Clustering:</strong> Primary clustering is one of the
        issues with linear probing. Many successive items form clusters, making
        it difficult to locate a free slot or to search for an element.
        <br />
        <br />
        <strong>Secondary Clustering:</strong> Secondary clustering is less
        severe, and two records can only share a collision chain (also known as
        a probe sequence) if they start out in the same location.
        <br />
        <br />
        ...
        <br></br>
        The worst time in linear probing to search an element is O ( table size
        ). This is due to
        <br></br>
        <ul>
          <li>
