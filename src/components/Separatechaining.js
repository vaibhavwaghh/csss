...
const Separatechaining = () => {
  ...
  return (
    <React.Fragment>
      <div className="sc1">
        <h>
          The idea behind separate chaining or Open hashing is to implement the
          array as a linked list called a chain. Separate chaining is one of the
          most popular and commonly used techniques in order to handle
          collisions.
        </h>
      </div>
      <div className="sc2">
        ...
        index, then these elements are inserted into a singly-linked list which
        is known as a chain.
      </div>
      <div className="sc3">
        Here, all those elements that hash into the same slot index are inserted
        into a linked list. Now, we can use a key K to search in the linked list
        by just linearly traversing. If the intrinsic key for any entry is equal
        to K then it means that we have found our entry. If we have reached the
        end of the linked list and yet we haven’t found our entry then it means
        that the entry does not exist. Hence, the conclusion is that in separate
        chaining, if two different elements have the same hash value then we
        store both the elements in the same linked list one after the other.
      </div>
      <div className="sc4">
        ...
        Performance of hashing can be evaluated under the assumption that each
        key is equally likely to be hashed to any slot of the table (simple
        uniform hashing). <br></br>m = Number of slots in hash table<br></br>n =
        Number of keys to be inserted in hash table<br></br>
      ...
      <div className="sc5">
        ...
        <strong>
          2. Dynamic Sized Arrays ( Vectors in C++, ArrayList in Java, list in
          Python)
        </strong>
        <br></br>
        <ul>
          <li>
            <strong>Search:</strong> O(l) where l = length of array
          </li>
          <li>
            <strong>Delete:</strong> O(l)
          </li>
          <li>
            <strong>Insert: </strong>O(l)
          </li>
          <li>
            <strong>Cache friendly</strong>
          </li>
        </ul>
        <strong>3. Self Balancing BST ( AVL Trees, Red-Black Trees)</strong>
        <br></br>
        <ul>
          <li>
            <strong>Search:</strong> O(log(l)) where l = length of linked list
          </li>
          <li>
            <strong>Delete:</strong> O(log(l))
          </li>
          <li>
            <strong>Insert:</strong> O(l)
          </li>
          <li>
            <strong>Not Cache friendly</strong>
          </li>
        </ul>
      </div>
      <div className="ex1">
